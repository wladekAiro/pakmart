        ...
        <section class="sidebar">
          ...
          <span class="input-group-btn">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="/administrator/manage/home"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a>
                </li>

                <li>
                    <a href="/administrator/manage/customers"><i class="fa fa-files-o"></i> <span>Customers</span></a>
                </li>
